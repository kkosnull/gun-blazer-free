...
public class explosion_force_laser : MonoBehaviour {
		...
		if (other.tag=="Enemy_pool"){
			...
			foreach (Collider hit in colliders) {
				...
				if (rb.GetComponent<DestroyByContact_pooled>()!=null){
						...
						rb.GetComponent<DestroyByContact_pooled>().enemy_life-=70;
						...
						rb.GetComponent<DestroyByContact>().enemy_life_droid-=70;
